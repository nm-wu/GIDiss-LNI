...
Informatikdissertationen 2019, \linebreak Lecture Notes in Informatics (LNI), Gesellschaft f{\"u}r Informatik, Bonn 2021 \hspace{5pt} \thepage \hspace{0.05cm}
}}%
...
\setlength{\doihoffset}{4.447cm}
\setlength{\doivoffset}{4.84cm}


\newcommand{\pdffilecc}[1]{%
  \includepdf[pages=1,noautoscale=true,pagecommand={\AddToShipoutPictureBG*{\put(\LenToUnit{\the\doihoffset},\LenToUnit{\the\doivoffset}){\AtPageLowerLeft{\ccbysa}}}},offset=7pt 42pt]{#1}%
  \includepdf[pages=2-,noautoscale=true,pagecommand={},offset=7pt 42pt]{#1}%
}
...
{Bannach, Max}
{Parallele Parametrisierte Algorithmen}
\pdffilecc{pdfs/Bannach-Max.pdf}

\sheader 
{Hierarchisches Planen durch Propositionale Logik}
{Behnke, Gregor}
{Hierarchisches Planen durch Propositionale Logik}
\pdffilecc{pdfs/Behnke-Gregor.pdf}
